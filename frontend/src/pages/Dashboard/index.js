...
export default function Dashboard(){
    ...
    //faz essa treta para apenas reconectar o socket quando o id do usuario mudar (user_id)
    ...
    async function handleAccept(id){
        ...
        setRequests(requests.filter(request => request._id !== id)); //remove das lista de solicitacoes
    }
